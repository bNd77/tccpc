...
<html>
<head>
    <title>Tabela Listagem de Medidas Protetivas</title>
    ...
    <div class="container">
        ...
        <table class="table table-striped table-bordered table-group-divider">
            ...
            <tbody>
                ...
                $sql = "SELECT * FROM medida_protetiva"; 
                ...
                if ($result->num_rows > 0) {
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        <a class='btn btn-primary mr-5' type='submit' href='editar.php?id=" . $row["id_medida"] . "''>
                        <i class='bi bi-pencil'></i>
                        
                        
                        </a>
                        <a class='btn btn-danger' href='excluir.php?id=" . $row["id_medida"] . "''>
