...
<head>
    <title>Tabela Listagem de vitimas</title>
            ...
            <tbody>
                ...
                if ($result->num_rows > 0) {
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        <a class='btn btn-primary mr-5' type='submit' href='editar.php?id=" . $row["id_vitima"] . "''>
                        <i class='bi bi-pencil'></i>
                        
                        
                        </a>
                        <a class='btn btn-danger' href='excluir.php?id=" . $row["id_vitima"] . "''>
